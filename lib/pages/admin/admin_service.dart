...
class AdminService {
  ...
  static Future<void> approveDocumentReview({required String userId}) {
    return _reviewDocumentUpdate(userId: userId, decision: 'approved');
  }
  ...
  static Future<void> _reviewDocumentUpdate({
    required String userId,
    required String decision,
    String? reason,
  }) async {
    final callable = _functions.httpsCallable('reviewDocumentUpdate');
    await callable.call<Map<String, dynamic>>(<String, dynamic>{
      'user_id': userId.trim(),
      'decision': decision,
      'reason': ?reason,
