  ...
  Future<void> _loadUserVerificationState() async {
    try {
      ...
      if (doc.exists && doc.data() != null) {
        final data = doc.data()!;
        setState(() {
          _isVerified = data['is_verified'] == true || data['isVerified'] == true;
    ...
    try {
      ...
      if (_idFile != null) {
        ...
        await idRef.putData(
          ...
          SettableMetadata(
            ...
            customMetadata: {'owner_id': widget.userId, 'field_name': 'id_image_url'},
          ),
        );
      ...
      if (_selfieFile != null) {
        ...
        await selfieRef.putData(
          ...
          SettableMetadata(
            ...
            customMetadata: {'owner_id': widget.userId, 'field_name': 'selfie_url'},
          ),
        );
      ...
      _showSnackBar(
        userFacingErrorMessage(
          e,
          fallback: 'Failed to upload verification documents. Please try again.',
        ),
      );
    }
  }
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildUploadSection(
                      ...
                      buttonText: _idFile == null ? 'Choose ID Photo' : 'Change Photo',
                    ...
                    _buildUploadSection(
                      ...
                      buttonText: _selfieFile == null ? 'Capture Selfie' : 'Recapture Selfie',
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton.icon(
                        onPressed: (_idFile == null && _selfieFile == null) || _isUploading
                            ? null
                            : _uploadDocuments,
                        icon: _isUploading
                            ? const SizedBox(
                        ...
                        label: Text(
                          _isUploading ? 'Uploading Documents...' : 'Submit Verification Documents',
      ...
      child: Row(
        children: [
          Container(
            ...
            child: Icon(
              _isVerified ? Icons.verified_rounded : Icons.pending_actions_rounded,
              color: badgeColor,
              size: 28,
            ),
          ),
