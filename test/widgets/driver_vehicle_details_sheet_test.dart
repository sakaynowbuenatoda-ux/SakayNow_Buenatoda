...
void main() {
  group('DriverVehicleInfoCard & Models Test Suite', () {
    testWidgets('renders fallback text when vehicle details are null or empty', (WidgetTester tester) async {
    ...
    testWidgets('renders explicit vehicle specifications when provided', (WidgetTester tester) async {
      await tester.pumpWidget(
        const MaterialApp(
          home: Scaffold(
            body: DriverVehicleInfoCard(
    ...
    test('AvailableDriver and DriverReviewProfile parse vehicle data and generate summary', () {
      ...
      expect(availableDriver.vehicleSummary, 'Traditional Tricycle • Blue • BUENA-101');
      ...
      expect(profile.vehicleSummary, 'Traditional Tricycle • Blue • BUENA-101');
    });
  });
}
